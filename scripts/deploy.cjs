...
function deployBasedOnBranch(branch) {
  ...
  try {
    ...
    if (branch === 'shadcnui') {
      deployUrl = `https://abdullahnaseem.github.io/${repoName}/shadcnui/`;
    } else if (branch === 'daisyui') {
      deployUrl = `https://abdullahnaseem.github.io/${repoName}/daisyui/`;
    } else {
      deployUrl = `https://abdullahnaseem.github.io/${repoName}/`;
    }
