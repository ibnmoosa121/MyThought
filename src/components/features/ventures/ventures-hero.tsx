            ...
            <div className="relative z-20 container mx-auto px-4 text-center max-w-5xl">
                ...
                >
                    ...
                    <p className="mt-8 text-lg md:text-xl text-neutral-400 max-w-2xl mx-auto">
                        {service.subtitle}. Investing in the bold minds that will redefine industries.
                    </p>
                    ...
                    >
                        <button className="px-10 py-4 bg-amber-600 hover:bg-amber-700 text-white font-bold rounded-xl transition-all shadow-[0_4px_14px_0_rgba(245,158,11,0.39)] hover:shadow-[0_6px_20px_rgba(245,158,11,0.23)] hover:-translate-y-1">
                            {service.cta}
                        </button>
                    </motion.div>
                </motion.div>
