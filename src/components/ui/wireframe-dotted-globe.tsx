  ...
  useEffect(() => {
    ...
    const loadWorldData = async () => {
      try {
        ...
        let totalDots = 0
        landFeatures.features.forEach((feature) => {
          const dots = generateDotsInPolygon(feature, 24) // Increased spacing from 16 to 24
        ...
        console.log(`[v0] Total dots generated: ${totalDots} across ${landFeatures?.features.length || 0} land features`)
