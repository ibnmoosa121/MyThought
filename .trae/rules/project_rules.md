...
DAISYUI_VARIANT:
- Check DaisyUI component library FIRST before building custom components
- Use semantic color classes: primary, secondary, accent, neutral
- Apply data-theme attribute for theme switching
- Use DaisyUI responsive modifiers (sm:, md:, lg:)
- Follow DaisyUI CSS custom property naming conventions
- Prefer DaisyUI component variants over custom Tailwind classes
- Reference DaisyUI documentation for component APIs
- /ui directory for primitive wrappers around DaisyUI components
- /layout directory for structural components
- /features directory for feature-specific UI
- /common directory for reusable shared components
